...
class FEF:
    """
    Class Representing one map (with some feature preference) in the input preprocessor stage of the salience_model
    This stage is attempting to salience_model the dynamics of the path from the LGN to cortex which ``consists of a strong
