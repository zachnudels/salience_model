...
def generate_block(
    ...
    if figure_dim[1] % 2 != 0 and figure_dim[0] % 2 != 0:
        image[mid_x - fig_x : mid_x + fig_x + 1, mid_y - fig_y : mid_y + fig_y + 1] = (
            figure_orientation
        )
    else:
        image[mid_x - fig_x : mid_x + fig_x, mid_y - fig_y : mid_y + fig_y] = (
            figure_orientation
        )
...
def generate_2_blocks(
    input_dim: Tuple[int, int] = (121, 121),
    figure_dim: Tuple[int, int] = (25, 25),
    figure_orientations: List[float] = None,
    bg_orientation: float = 0,
    midpoints: List[Tuple[int, int]] = None,
) -> np.ndarray:
    ...
    if fig_x == 0 and fig_y != 0:
        ...
        image[mid1_x - fig_x : mid1_x + fig_x, mid1_y - fig_y : mid1_y + fig_y] = (
            figure_orientations[0]
        )
    ...
    if fig_x == 0 and fig_y != 0:
        ...
        image[mid2_x - fig_x : mid2_x + fig_x, mid2_y - fig_y : mid2_y + fig_y] = (
            figure_orientations[1]
        )
    return image
